...
class HomeViewController: UIViewController, UINavigationControllerDelegate, MenuListControllerDelegate  {
    ...
    private let sidemenuHomeContorller = SidemenuHomeViewController()
    private let ordersViewController = YourOrdersViewController()
    private let viewCartController = ViewCartViewController()
    ...
    func didSelectItems(named: SideMenuItem) {
        ...
        case .home:
            ...
            let vc = storyBoard.instantiateViewController(withIdentifier: "SidemenuHomeViewController")
            self.navigationController?.pushViewController(vc, animated: true)
        case .YourOrders:
            let storyBoard = UIStoryboard(name: "Main", bundle: nil)
            let vc = storyBoard.instantiateViewController(withIdentifier: "YourOrdersViewController")
            self.navigationController?.pushViewController(vc, animated: true)
        case .viewcart:
            let storyBoard = UIStoryboard(name: "Main", bundle: nil)
            let vc = storyBoard.instantiateViewController(withIdentifier: "ViewCartViewController")
            self.navigationController?.pushViewController(vc, animated: true)
        }
    }
}
...
extension HomeViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let imageurl = populars[indexPath.item].image
        print(imageurl ?? "")
        viewController.headerImage = imageurl
